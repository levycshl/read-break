...
def main():
    ...
    data_dir = Path(r"Z:/mnt/wigstore3/data/checkpointcharlie/Debmalya/251015_M00164_0705_000000000-M6JMT/Alignment_1/20251016_193622/Fastq")
    output_dir = Path(r"Z:/data/safe/levy/read_break/2025_10_17_alu_capture_deaminate")
    ...
    libs = {k: v for k, v in libs.items() if k.startswith("D")}
